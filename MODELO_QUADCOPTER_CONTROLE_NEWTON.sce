...
diretorio = (get_absolute_file_path('MODELO_QUADCOPTER_CONTROLE_NEWTON.sce'))
...
z_d=0;     // Altitude desejada (metros)

//*************************************
// EXECUÇÃO DO DIAGRAMA DE BLOCOS
//*************************************

importXcosDiagram(diretorio + "MODELO_QUADCOPTER_CONTROLE_NEWTON.zcos") // Importa diagrama
...
arquivo = "MODELO_QUADCOPTER_CONTROLE_NEWTON.txt";

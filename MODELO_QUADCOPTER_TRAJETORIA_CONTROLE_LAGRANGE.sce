...
disp("-- MODELAGEM DE UM QUADRIRROTOR - TRAJETÓRIA - EULER-LAGRANGE - CONTROLE P.I.D. --")
...
diretorio = (get_absolute_file_path('MODELO_QUADCOPTER_TRAJETORIA_CONTROLE_LAGRANGE.sce'))
...
pos_final = 2; // Posição final desejada [m]

a_jounce = pos_final / 0.66666;
b_jounce = 0.5;

disp("Posição final desejada [m]:")
disp(pos_final)
...
kp_y=3;      // Ganho kp do eixo z
ki_y=0;      // Ganho ki do eixo z
kd_y=1;      // Ganho kd do eixo z

kp_z=3;      // Ganho kp do eixo z
...
importXcosDiagram(diretorio + "MODELO_QUADCOPTER_TRAJETORIA_CONTROLE_LAGRANGE.zcos") // Importa diagrama
...
arquivo = "MODELO_QUADCOPTER_TRAJETORIA_CONTROLE_LAGRANGE.txt";
